package com.dangerfield.hiittimer.libraries.hiittimer.impl.logging

import com.dangerfield.hiittimer.libraries.core.logging.LogContext
import com.dangerfield.hiittimer.libraries.core.logging.LogEntry
import com.dangerfield.hiittimer.libraries.core.logging.LogId
import com.dangerfield.hiittimer.libraries.core.logging.LogLevel
import com.dangerfield.hiittimer.libraries.core.logging.LogTree

/**
 * Forwards structured log entries to the existing Kermit logger so new callers using [com.dangerfield.hiittimer.libraries.core.logging.KLog]
