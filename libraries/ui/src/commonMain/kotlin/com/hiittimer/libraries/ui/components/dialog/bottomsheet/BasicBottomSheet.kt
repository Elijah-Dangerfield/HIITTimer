...
import com.dangerfield.hiittimer.libraries.ui.components.dialog.ModalContent
...
private fun PreviewBasicBottomSheet() {
    PreviewContent {
        com.dangerfield.hiittimer.libraries.ui.components.dialog.bottomsheet.BasicBottomSheet(
            state = rememberBottomSheetState(BottomSheetValue.Expanded),
            onDismissRequest = { -> },
            modifier = Modifier,
            stickyTopContent = { Text(text = "Top Content") },
