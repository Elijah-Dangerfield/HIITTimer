...
class BottomSheetState(
    ...
    companion object {
        ...
        fun Saver(confirmValueChange: (BottomSheetValue) -> Boolean, density: Density): Saver<com.dangerfield.hiittimer.libraries.ui.components.dialog.bottomsheet.BottomSheetState, *> =
            Saver(
