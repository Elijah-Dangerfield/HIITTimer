package com.dangerfield.hiittimer.libraries.ui.components.icon
...
import com.dangerfield.hiittimer.libraries.ui.components.icon.icons.App_shortcut
import com.dangerfield.hiittimer.libraries.ui.components.icon.icons.HomeFilled
import com.dangerfield.hiittimer.libraries.ui.components.icon.icons.TipJarIcon
...
enum class Icons(
    ...
    Home(
        default = com.dangerfield.hiittimer.libraries.ui.components.icon.icons.Home,
        filled = HomeFilled,
        outlined = com.dangerfield.hiittimer.libraries.ui.components.icon.icons.Home,
    ),
    ...
    SnowFlake(com.dangerfield.hiittimer.libraries.ui.components.icon.icons.SnowFlake),
