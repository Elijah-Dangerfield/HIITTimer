...
import com.dangerfield.hiittimer.libraries.ui.components.icon.IconButton.Size
...
private fun PreviewIconButtons() {
    PreviewContent() {
        LazyVerticalGrid(
            ...
            items(com.dangerfield.hiittimer.libraries.ui.components.icon.iconButtons) { icon ->
                Column(
                    horizontalAlignment = Alignment.CenterHorizontally,
                    verticalArrangement = Arrangement.Center,
                    modifier = Modifier.padding(8.dp)
                ) {
                    com.dangerfield.hiittimer.libraries.ui.components.icon.IconButton(
                        icon = icon,
