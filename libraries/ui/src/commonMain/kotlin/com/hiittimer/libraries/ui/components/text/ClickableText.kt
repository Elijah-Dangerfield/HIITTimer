...
import com.dangerfield.hiittimer.libraries.ui.ANNOTATED_STRING_ON_CLICK_KEY
import com.dangerfield.hiittimer.libraries.ui.ANNOTATED_STRING_URL_KEY
import com.dangerfield.hiittimer.libraries.ui.ClickableTextDefaults
import com.dangerfield.hiittimer.libraries.ui.ClickableTextSegment
import com.dangerfield.hiittimer.libraries.ui.ClickableTextValue
import com.dangerfield.hiittimer.libraries.ui.LinkAppearance
...
private fun ClickableTextCatalogPreview() {
    PreviewContent {
        Column(
            ...
            ClickableText(
                text = "Visit https://hiittimer.app/support or https://status.hiittimer.app for updates.",
                onClickUrl = {}
            )
            ...
            ClickableText(
                text = "Auto-linking disabled even though https://hiittimer.app/docs is present.",
                autoLinkUrls = false
            )

            ClickableText(
                text = "Custom auto link style https://hiittimer.app/pricing",
